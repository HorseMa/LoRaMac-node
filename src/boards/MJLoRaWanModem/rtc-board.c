...
TimerTime_t RtcGetElapsedAlarmTime( void )
{
    ...
    contextTime = sTartAlarmTimerTime;
...
static void RtcComputeWakeUpTime( void )
{
    ...
    {
        McuWakeUpTime = TimerGetElapsedTime(sTartAlarmTimerTime);
    ...
    if( WakeUpTimeInitialized == false )
    {
        ...
        start = aLarmTimerTime;
        stop = RtcConvertCalendarTickToTimerTime( NULL );
...
static void RtcStartWakeUpAlarm( uint32_t timeoutValue )
{
    sTartAlarmTimerTime = systick;
    aLarmTimerTime = timeoutValue;
}
...
static TimerTime_t RtcConvertCalendarTickToTimerTime( RtcCalendar_t *calendar )
{
    ...
    {
        timeCounter = sTartAlarmTimerTime;
    }
